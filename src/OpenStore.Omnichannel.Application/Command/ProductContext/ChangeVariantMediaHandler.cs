...
public class ChangeVariantMediaHandler : ICommandHandler<ChangeVariantMedia>
{
    ...
    public async Task Handle(ChangeVariantMedia command, CancellationToken cancellationToken)
    {
